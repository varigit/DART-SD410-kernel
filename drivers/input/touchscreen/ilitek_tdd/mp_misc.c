...
int msg28xx_short_judge(int *deltac_data)
{
    ...
    //unused-variable: int count_test_pin = 0;
	//unused-variable: int shift;
    int thrs = 0;
   	//unused-variable: int RealThrs = 0;
    //unused-variable: u16 Temp_20_3E_Settings[16] = {0};
    //unused-variable: u16 nTestItemLoop = 6;
    //unused-variable: u16 nTestItem = 0;
    u32 nRetVal = 1;
    //unused-variable: char str[512] = {0};
...
int msg30xx_short_judge(int *deltac_data)
{
	...
	//unused-variable: int RealThrs = 0;
    //unused-variable: u16 Temp_20_3E_Settings[16] = {0};
    //unused-variable: u16 nTestItemLoop = 6 - 1;
    //unused-variable: u16 nTestItem = 0;
    u32 nRetVal = 1;
    //unused-variable: char str[512] = {0};
    int datalen1 = 0;
...
int msg30xx_uniformity_judge(int *deltac_data, int deltac_size)
{
	...
	//unused-variable: int bd_top_cut = 5;
