...
{
    //unused-variable: int regData = 0;
    //unused-variable: int timeout = 280;
    //unused-variable: int t = 0;
...
static int new_flow_start_test(void)
{
    ...
    //unused-variable: static int get_deltac_flag = 0, count = 0;
